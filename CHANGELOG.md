...
* **deps-dev:** package updates ([b49b2ab](https://github.com/unbekannt3/room-card-minimalist/commit/b49b2abb10495a133712a2a7072e7bc24529a475))
* **release:** 1.4.3-beta.1 [skip ci] ([7d65442](https://github.com/unbekannt3/room-card-minimalist/commit/7d65442892719768afc54660098591219f54b786))
...
* ci: downgrade semantic-release to v24 ([e8a918a](https://github.com/unbekannt3/room-card-minimalist/commit/e8a918a))
* ci: fix package.lock semantic-release downgrade ([252f698](https://github.com/unbekannt3/room-card-minimalist/commit/252f698))
* ci: node 22 ([7f31b0a](https://github.com/unbekannt3/room-card-minimalist/commit/7f31b0a))
* ci: node 24 ([21bb535](https://github.com/unbekannt3/room-card-minimalist/commit/21bb535))
* ci: node 24 ([6fb4930](https://github.com/unbekannt3/room-card-minimalist/commit/6fb4930))
* ci: node version on build ([41c4971](https://github.com/unbekannt3/room-card-minimalist/commit/41c4971))
* ci: semantic release stuff ([8e09cbd](https://github.com/unbekannt3/room-card-minimalist/commit/8e09cbd))
* ci: semantic-release debug ([3fd7cb3](https://github.com/unbekannt3/room-card-minimalist/commit/3fd7cb3))
* ci: set explicit node 22.14 ([feddf54](https://github.com/unbekannt3/room-card-minimalist/commit/feddf54))
* ci: setup node v6 ([039592e](https://github.com/unbekannt3/room-card-minimalist/commit/039592e))
* ci: sign semantic releases ([ab27034](https://github.com/unbekannt3/room-card-minimalist/commit/ab27034))
* ci: test build without signing ([90d7fc1](https://github.com/unbekannt3/room-card-minimalist/commit/90d7fc1))
* chore: added missing multi-state entities to README ([3a242ca](https://github.com/unbekannt3/room-card-minimalist/commit/3a242ca))
* chore: let claude update the README ([8f46324](https://github.com/unbekannt3/room-card-minimalist/commit/8f46324))
* chore: prettier format ([9c98c2d](https://github.com/unbekannt3/room-card-minimalist/commit/9c98c2d))
* chore: testing multi states ([75dcc08](https://github.com/unbekannt3/room-card-minimalist/commit/75dcc08))
* chore(release): 1.3.0-beta.1 [skip ci] ([3a36735](https://github.com/unbekannt3/room-card-minimalist/commit/3a36735))
* chore(release): 1.3.0-beta.1 [skip ci] ([956c81e](https://github.com/unbekannt3/room-card-minimalist/commit/956c81e))
* chore(release): 1.3.0-beta.1 [skip ci] ([8d5331d](https://github.com/unbekannt3/room-card-minimalist/commit/8d5331d))
* Merge pull request #31 from unbekannt3/next-dev ([a514b90](https://github.com/unbekannt3/room-card-minimalist/commit/a514b90)), closes [#31](https://github.com/unbekannt3/room-card-minimalist/issues/31)
* feat: #25 show values in entity state circles ([4342aeb](https://github.com/unbekannt3/room-card-minimalist/commit/4342aeb)), closes [#25](https://github.com/unbekannt3/room-card-minimalist/issues/25)
* feat: tertiary info field ([bf7a69f](https://github.com/unbekannt3/room-card-minimalist/commit/bf7a69f))
* fix: don't mark card clickable when non supported doubletap action defined in code ([eec9bbf](https://github.com/unbekannt3/room-card-minimalist/commit/eec9bbf))
* fix: node vulns ([80480b3](https://github.com/unbekannt3/room-card-minimalist/commit/80480b3))
* fix: prettier config for yaml ([17718a3](https://github.com/unbekannt3/room-card-minimalist/commit/17718a3))
* fix: schemas.ts typescript literal ([9d0ab74](https://github.com/unbekannt3/room-card-minimalist/commit/9d0ab74))
* i18n: improve wording for reverse ordering states ([50df564](https://github.com/unbekannt3/room-card-minimalist/commit/50df564))
* refactor: migrate codebase to Typescript ([80eba7e](https://github.com/unbekannt3/room-card-minimalist/commit/80eba7e))
...
* ci: fix release semantic config ([4f9f573](https://github.com/unbekannt3/room-card-minimalist/commit/4f9f573))
* ci: fix release.yaml ([12693e7](https://github.com/unbekannt3/room-card-minimalist/commit/12693e7))
* ci: fix semantic-release commit message for commitlint ([d37c03b](https://github.com/unbekannt3/room-card-minimalist/commit/d37c03b))
* ci: prereleases from next branch ([e4a9a20](https://github.com/unbekannt3/room-card-minimalist/commit/e4a9a20))
* ci: switch to semantic-release ([ec77a34](https://github.com/unbekannt3/room-card-minimalist/commit/ec77a34))
* feat: add interactive secondary info and HTML support ([1dcce36](https://github.com/unbekannt3/room-card-minimalist/commit/1dcce36))
* feat: allow HTML in secondary info ([02103e3](https://github.com/unbekannt3/room-card-minimalist/commit/02103e3))
* feat: internationalization support ([6ca2a6b](https://github.com/unbekannt3/room-card-minimalist/commit/6ca2a6b))
* feat: secondary info actions ([801003d](https://github.com/unbekannt3/room-card-minimalist/commit/801003d))
* Merge pull request #12 from unbekannt3/release-please--branches--main--components--room-card-minimal ([3b5b49a](https://github.com/unbekannt3/room-card-minimalist/commit/3b5b49a)), closes [#12](https://github.com/unbekannt3/room-card-minimalist/issues/12)
* Merge pull request #13 from unbekannt3/release-please--branches--main--components--room-card-minimal ([f4b5c4e](https://github.com/unbekannt3/room-card-minimalist/commit/f4b5c4e)), closes [#13](https://github.com/unbekannt3/room-card-minimalist/issues/13)
* Merge pull request #15 from unbekannt3/release-please--branches--main--components--room-card-minimal ([e34505b](https://github.com/unbekannt3/room-card-minimalist/commit/e34505b)), closes [#15](https://github.com/unbekannt3/room-card-minimalist/issues/15)
* Merge pull request #16 from unbekannt3/release-please--branches--next--components--room-card-minimal ([1e4a0c6](https://github.com/unbekannt3/room-card-minimalist/commit/1e4a0c6)), closes [#16](https://github.com/unbekannt3/room-card-minimalist/issues/16)
* Merge pull request #18 from unbekannt3/dependabot/npm_and_yarn/js-yaml-4.1.1 ([f9d6fcb](https://github.com/unbekannt3/room-card-minimalist/commit/f9d6fcb)), closes [#18](https://github.com/unbekannt3/room-card-minimalist/issues/18)
* Merge pull request #19 from unbekannt3/release-please--branches--next--components--room-card-minimal ([5460954](https://github.com/unbekannt3/room-card-minimalist/commit/5460954)), closes [#19](https://github.com/unbekannt3/room-card-minimalist/issues/19)
* chore: add few more badges to readme ([5b231f4](https://github.com/unbekannt3/room-card-minimalist/commit/5b231f4))
* chore: add LICENSE ([42a6ec4](https://github.com/unbekannt3/room-card-minimalist/commit/42a6ec4))
* chore: add padding workaround info to README ([711b8d3](https://github.com/unbekannt3/room-card-minimalist/commit/711b8d3))
* chore: add pr-version commit script ([2fc4fc2](https://github.com/unbekannt3/room-card-minimalist/commit/2fc4fc2))
* chore: clarify template capabilities in README ([f10ecb5](https://github.com/unbekannt3/room-card-minimalist/commit/f10ecb5))
* chore: localization fixes ([122364f](https://github.com/unbekannt3/room-card-minimalist/commit/122364f))
* chore: release 1.1.1-beta.0 ([c9fc34b](https://github.com/unbekannt3/room-card-minimalist/commit/c9fc34b))
* chore: release 1.1.1-beta.1 ([37440a8](https://github.com/unbekannt3/room-card-minimalist/commit/37440a8))
* chore: release 1.1.1-beta.2 ([0d6d13e](https://github.com/unbekannt3/room-card-minimalist/commit/0d6d13e))
* chore: release 1.2.0-beta.0 ([94521fd](https://github.com/unbekannt3/room-card-minimalist/commit/94521fd))
* chore: release 1.2.0-beta.1 ([1849004](https://github.com/unbekannt3/room-card-minimalist/commit/1849004))
* chore: webpack proper minification of css/html in literals ([a4bd648](https://github.com/unbekannt3/room-card-minimalist/commit/a4bd648))
* chore(deps-dev): bump js-yaml from 4.1.0 to 4.1.1 ([0e23aa5](https://github.com/unbekannt3/room-card-minimalist/commit/0e23aa5))
* chore(main): release 1.1.1-beta.0 ([733870c](https://github.com/unbekannt3/room-card-minimalist/commit/733870c))
* chore(main): release 1.1.1-beta.1 ([7cbcbe3](https://github.com/unbekannt3/room-card-minimalist/commit/7cbcbe3))
* chore(main): release 1.1.1-beta.2 ([4260b0e](https://github.com/unbekannt3/room-card-minimalist/commit/4260b0e))
* chore(next): release 1.2.0-beta.0 ([9cd14cc](https://github.com/unbekannt3/room-card-minimalist/commit/9cd14cc))
* chore(next): release 1.2.0-beta.1 ([7491a02](https://github.com/unbekannt3/room-card-minimalist/commit/7491a02))
* i18n: translation changes ([434ea7b](https://github.com/unbekannt3/room-card-minimalist/commit/434ea7b))
* fix: editor entity select width ([2b3fee3](https://github.com/unbekannt3/room-card-minimalist/commit/2b3fee3))
* fix: reverse ordering of states not starting at card bottom ([f24c25b](https://github.com/unbekannt3/room-card-minimalist/commit/f24c25b))
